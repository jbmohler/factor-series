    ...
    for i in range(base1, base2):
        for j in m630:
            ...
            if M % 3 == 2:
                xoff = 4 * (M - 2) // 3 + 3
                punk = base + 3 * md4
            test1 = is_prime(xmid) and is_prime(xoff) and count_factors(punk) == n
...
def test_range_star630_silent(n, base1, base2):
    return list(test_range_star630(n, base1, base2))
...
if __name__ == "__main__":
    ...
    def chunks():
        func = test_range_star630_silent

        for o1 in range(0, MAX):
            # print(f'Layer {o1} of {MAX}')
            yield (func, (2, o1 * 1000, (o1 + 1) * 1000), {})
